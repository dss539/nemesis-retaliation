...
- [ ] Owner decision required before corpus repair: approve the cluster order/scope and decide whether to recut/re-extract and freshly rerun the five slice defects (`OBJ-29`, `OBJ-31`, `OBJ-32`, `CARD-character-heavy-gun-operator-character-heavy-gun-operator-045_cards-card-13.png`, `CARD-game-missionTaskDeck-game-missionTaskDeck-160_cards-card-08.png`) before or alongside repair.
