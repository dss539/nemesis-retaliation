...
- [ ] Give P4 and P5 exactly one fresh independent verifier verdict each and reconcile closure.
- [ ] Corpus repair approval is not yet requested. After the two reslice verdicts close, prepare an approval-ready source-to-rule mapping and proposed concise-corpus diff for the 332 independently confirmed gaps; cluster labels/counts alone are insufficient.
