...
- [ ] Owner review: approve, reject, or amend P1–P5 in that packet. P1–P3 retire non-verifiable physically occluded occurrences from the rules-verification manifest while preserving source provenance; P4–P5 install complete pixel-bound source-variant slices and receive one fresh verifier rerun each.
- [ ] Corpus repair approval is not yet requested. After reslice disposition, prepare an approval-ready source-to-rule mapping and proposed concise-corpus diff for the 332 independently confirmed gaps; cluster labels/counts alone are insufficient.
