...
- [ ] Owner: read OWNER-NOTES; rule on corpse scope (OQ-013); decide on a publisher/BGG Q&A round from the unsure ledger; decide whether the rules layer meets the rewrite gate.
