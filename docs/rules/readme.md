...
- `00-foundations.md` — scope, terminology, participation/cooperation structure, relevant finite setup and state supplies, Room geometry, Corridor spacing/extent, and cross-cutting conventions (FND-001–008).
