...
EXPECTED = {
    ...
    'redItemRootOccurrences': 30, 'redItemRegularOccurrences': 21,
    'redItemExcludedHeavyOccurrences': 3, 'redItemClassConflictOccurrences': 6,
    'redItemUniqueTitles': 7, 'redItemSelectedFaceAssets': 7, 'redItemSourceFaceAssets': 16,
    'redItemGeneratedRegularOccurrences': 7, 'redItemDirectRegularOccurrences': 14,
    'redItemRootBackAssets': 2, 'redItemSourceSheets': 2,
    'redItemRedSelectorGaps': 4, 'redItemCrossFamilySelectorGaps': 3,
    'redItemPhysicalRegions': 63, 'redItemOperativeRegions': 42,
    'redItemPhysicalPanels': 87, 'redItemOperativePanels': 66,
    'redItemPrintedSentences': 45, 'redItemFunctionalIconOccurrences': 27,
    'redItemMatchedIconOccurrences': 23, 'redItemUnresolvedLocalGlyphOccurrences': 4,
    'redItemLicensedOccurrences': 9, 'redItemLicensedCopies': 30,
    'redItemLicensedRegularCopies': 21, 'redItemLicensedHeavyCopies': 9,
    'redItemOfficialRegularFaceOccurrences': 0, 'redItemOfficialHeavySameTitleOccurrences': 1,
    'redItemOfficialBackOccurrences': 0, 'redItemOfficialFamilyOccurrences': 14,
    'redItemRecords': 21, 'redItemBacklogTuples': 11,
    'yellowItemRootOccurrences': 30, 'yellowItemRegularOccurrences': 24,
    'yellowItemExplicitHeavyOccurrences': 0, 'yellowItemClassConflictOccurrences': 6,
    'yellowItemUniqueTitles': 4, 'yellowItemSelectedFaceAssets': 4, 'yellowItemSourceFaceAssets': 11,
    'yellowItemGeneratedRegularOccurrences': 11, 'yellowItemDirectRegularOccurrences': 13,
    'yellowItemRootBackAssets': 2, 'yellowItemSourceSheets': 2,
    'yellowItemSelectorGaps': 5, 'yellowItemCrossFamilySelectorGaps': 1,
    'yellowItemPhysicalRegions': 72, 'yellowItemOperativeRegions': 48,
    'yellowItemPhysicalPanels': 128, 'yellowItemOperativePanels': 104,
    'yellowItemPrintedSentences': 56, 'yellowItemFunctionalIconOccurrences': 48,
    'yellowItemMatchedIconOccurrences': 32, 'yellowItemUnresolvedLocalGlyphOccurrences': 16,
    'yellowItemLicensedOccurrences': 6, 'yellowItemLicensedCopies': 30,
    'yellowItemLicensedRegularCopies': 24, 'yellowItemLicensedHeavyCopies': 6,
    'yellowItemOfficialRegularFaceOccurrences': 1, 'yellowItemOfficialBackOccurrences': 0,
    'yellowItemOfficialFamilyOccurrences': 15, 'yellowItemRecords': 24,
    'yellowItemBacklogTuples': 7,
    'actionPhysicalOccurrences': 60, 'actionCharacterDecks': 6,
    'actionRootDecks': 7, 'actionSourceFaceAssets': 89,
    'actionDirectOccurrences': 39, 'actionGeneratedOccurrences': 21,
    'actionSourceSheets': 2, 'actionSelectorGaps': 29,
    'actionSharedBackOccurrences': 1, 'actionSharedBackReferences': 273,
    'actionUniqueTitles': 32, 'actionPrintedSentences': 164,
    'actionPhysicalPanels': 290, 'actionOperativePanels': 136,
    'actionFunctionalIconOccurrences': 143, 'actionMatchedIconOccurrences': 129,
    'actionUnresolvedLocalGlyphOccurrences': 14,
    'actionResolvedNotInCombatOccurrences': 28, 'actionUnresolvedUpperRightOccurrences': 8,
    'actionZeroPlayCosts': 60, 'actionAdditionalCostClauses': 22,
    'actionCommandHeadings': 8, 'actionReactionHeadings': 6,
    'actionLicensedOccurrences': 60, 'actionLicensedReactionOccurrences': 6,
    'actionLicensedCommandOccurrences': 7, 'actionLicensedNotInCombatOccurrences': 35,
    'actionOfficialFaceOccurrences': 4, 'actionOfficialBackOccurrences': 2,
...
def validate(event_source_path: Path, exploration_source_path: Path, robot_source_path: Path, attack_source_path: Path, queen_health_source_path: Path, serious_wound_source_path: Path, green_item_source_path: Path, red_item_source_path: Path, yellow_item_source_path: Path, equipment_source_path: Path, action_source_path: Path, objective_source_path: Path, combat_source_path: Path, facility_source_path: Path, source_path: Path, schema_path: Path, semantic_vocabulary_path: Path, room_icon_path: Path, pilots_path: Path, review_path: Path, contradictions_path: Path, coverage_path: Path, backlog_path: Path, *, reproducibility: bool) -> dict:  # pyright: ignore[reportGeneralTypeIssues]
    ...
    red_validation = validate_red_item_family(
        REPO, red_item_source_path, red_item_sources, source_by_id, backlog_rows_by_id,
        roles, load(REPO/'assets/tts-mod/extract/v2/objects.json'), secondary, bga_text,
        record_by_id, question_by_id, conflict_rows, coverage, failures,
    )
    yellow_validation = validate_yellow_item_family(
        REPO, yellow_item_source_path, yellow_item_sources, source_by_id, backlog_rows_by_id,
        roles, load(REPO/'assets/tts-mod/extract/v2/objects.json'), secondary, bga_text,
        record_by_id, question_by_id, conflict_rows, coverage, failures,
    )
    ...
    if [row.get('operationType') for row in action_draw.get('operations') or []] != ['evaluate-condition','shuffle','draw-random','resolve-open-alternative'] or 'SEM-Q-072' not in action_draw.get('unresolvedQuestionRefs',[]) or not any(row.get('invokeRuleId') == 'SEM-ACTION-CARD-DRAW-001' and (row.get('repeat') or {}).get('perCharacter') == 2 for row in (record_by_id.get('SEM-QUEEN-HEALTH-503900-B42831-001') or {}).get('operations') or []):
    ...
    actual_counts = {
        ...
        'redItemRootOccurrences': len((red_item_sources.get('rootDeckEvidence') or {}).get('fullContainedSelectors') or []),
        'redItemRegularOccurrences': len(red_validation['rows']),
        'redItemExcludedHeavyOccurrences': len(red_validation['heavy']),
        'redItemClassConflictOccurrences': len(red_validation['classConflicts']),
        'redItemUniqueTitles': len({item.get('printedTitle') for item in red_validation['rows']}),
        'redItemSelectedFaceAssets': len({item.get('sourceSha256') for item in red_validation['rows']}),
        'redItemSourceFaceAssets': len(red_validation['assets']),
        'redItemGeneratedRegularOccurrences': sum((item.get('sourceSelector') or {}).get('generatedSpriteSheetCell') is True for item in red_validation['rows']),
        'redItemDirectRegularOccurrences': sum((item.get('sourceSelector') or {}).get('generatedSpriteSheetCell') is False for item in red_validation['rows']),
        'redItemRootBackAssets': len(red_item_sources.get('rootBacks') or []),
        'redItemSourceSheets': len(red_item_sources.get('sourceSheets') or []),
        'redItemRedSelectorGaps': sum(item.get('selectedDisposition') == 'red-selector-gap' for item in red_validation['assets']),
        'redItemCrossFamilySelectorGaps': sum(item.get('selectedDisposition') == 'cross-family-gap-excluded' for item in red_validation['assets']),
        'redItemPhysicalRegions': sum(len(item.get('regions') or []) for item in red_validation['rows']),
        'redItemOperativeRegions': sum(sum(region.get('operative') is True for region in item.get('regions') or []) for item in red_validation['rows']),
        'redItemPhysicalPanels': sum(len(item.get('panels') or []) for item in red_validation['rows']),
        'redItemOperativePanels': sum(sum(panel.get('operative') is True for panel in item.get('panels') or []) for item in red_validation['rows']),
        'redItemPrintedSentences': sum(len(item.get('sentences') or []) for item in red_validation['rows']),
        'redItemFunctionalIconOccurrences': sum(len(item.get('iconOccurrences') or []) for item in red_validation['rows']),
        'redItemMatchedIconOccurrences': sum(sum(icon.get('semanticReferenceId') is not None for icon in item.get('iconOccurrences') or []) for item in red_validation['rows']),
        'redItemUnresolvedLocalGlyphOccurrences': sum(sum(icon.get('semanticReferenceId') is None for icon in item.get('iconOccurrences') or []) for item in red_validation['rows']),
        'redItemLicensedOccurrences': len(red_validation['licensed']),
        'redItemLicensedCopies': sum(item.get('nbr',0) for item in red_validation['licensed']),
        'redItemLicensedRegularCopies': sum(item.get('nbr',0) for item in red_validation['licensed'] if not item.get('heavy') and not item.get('armor')),
        'redItemLicensedHeavyCopies': sum(item.get('nbr',0) for item in red_validation['licensed'] if item.get('heavy') or item.get('armor')),
        'redItemOfficialRegularFaceOccurrences': sum(item.get('exactRegularRedRulesFace') is True for item in red_validation['official']),
        'redItemOfficialHeavySameTitleOccurrences': sum(item.get('kind') == 'current-military-taser-heavy-face' for item in red_validation['official']),
        'redItemOfficialBackOccurrences': sum(item.get('kind') == 'shared-back' for item in red_validation['official']),
        'redItemOfficialFamilyOccurrences': len(red_validation['official']),
        'redItemRecords': len(red_validation['actualRuleIds']),
        'redItemBacklogTuples': sum((backlog_rows_by_id.get(backlog_id) or {}).get('pilotRuleIds') == rule_ids for backlog_id,rule_ids in red_validation['expectedBacklogRules'].items()),
        'yellowItemRootOccurrences': len((yellow_item_sources.get('rootDeckEvidence') or {}).get('fullContainedSelectors') or []),
        'yellowItemRegularOccurrences': len(yellow_validation['rows']),
        'yellowItemExplicitHeavyOccurrences': yellow_item_sources.get('counts',{}).get('explicitHeavyPhysicalOccurrences'),
        'yellowItemClassConflictOccurrences': len(yellow_validation['classConflicts']),
        'yellowItemUniqueTitles': len({item.get('printedTitle') for item in yellow_validation['rows']}),
        'yellowItemSelectedFaceAssets': len({item.get('sourceSha256') for item in yellow_validation['rows']}),
        'yellowItemSourceFaceAssets': len(yellow_validation['assets']),
        'yellowItemGeneratedRegularOccurrences': sum((item.get('sourceSelector') or {}).get('generatedSpriteSheetCell') is True for item in yellow_validation['rows']),
        'yellowItemDirectRegularOccurrences': sum((item.get('sourceSelector') or {}).get('generatedSpriteSheetCell') is False for item in yellow_validation['rows']),
        'yellowItemRootBackAssets': len(yellow_item_sources.get('rootBacks') or []),
        'yellowItemSourceSheets': len(yellow_item_sources.get('sourceSheets') or []),
        'yellowItemSelectorGaps': sum(item.get('selectorGap') is not None for item in yellow_validation['assets']),
        'yellowItemCrossFamilySelectorGaps': sum(item.get('selectedDisposition') == 'cross-family-gap-excluded' for item in yellow_validation['assets']),
        'yellowItemPhysicalRegions': sum(len(item.get('regions') or []) for item in yellow_validation['rows']),
        'yellowItemOperativeRegions': sum(sum(region.get('operative') is True for region in item.get('regions') or []) for item in yellow_validation['rows']),
        'yellowItemPhysicalPanels': sum(len(item.get('panels') or []) for item in yellow_validation['rows']),
        'yellowItemOperativePanels': sum(sum(panel.get('operative') is True for panel in item.get('panels') or []) for item in yellow_validation['rows']),
        'yellowItemPrintedSentences': sum(len(item.get('sentences') or []) for item in yellow_validation['rows']),
        'yellowItemFunctionalIconOccurrences': sum(len(item.get('iconOccurrences') or []) for item in yellow_validation['rows']),
        'yellowItemMatchedIconOccurrences': sum(sum(icon.get('semanticReferenceId') is not None for icon in item.get('iconOccurrences') or []) for item in yellow_validation['rows']),
        'yellowItemUnresolvedLocalGlyphOccurrences': sum(sum(icon.get('semanticReferenceId') is None for icon in item.get('iconOccurrences') or []) for item in yellow_validation['rows']),
        'yellowItemLicensedOccurrences': len(yellow_validation['licensed']),
        'yellowItemLicensedCopies': sum(item.get('nbr',0) for item in yellow_validation['licensed']),
        'yellowItemLicensedRegularCopies': sum(item.get('nbr',0) for item in yellow_validation['licensed'] if not item.get('heavy') and not item.get('armor')),
        'yellowItemLicensedHeavyCopies': sum(item.get('nbr',0) for item in yellow_validation['licensed'] if item.get('heavy') or item.get('armor')),
        'yellowItemOfficialRegularFaceOccurrences': sum(item.get('exactRegularYellowRulesFace') is True for item in yellow_validation['official']),
        'yellowItemOfficialBackOccurrences': sum(item.get('kind') == 'shared-back' for item in yellow_validation['official']),
        'yellowItemOfficialFamilyOccurrences': len(yellow_validation['official']),
        'yellowItemRecords': len(yellow_validation['actualRuleIds']),
        'yellowItemBacklogTuples': sum((backlog_rows_by_id.get(backlog_id) or {}).get('pilotRuleIds') == rule_ids for backlog_id,rule_ids in yellow_validation['expectedBacklogRules'].items()),
        'equipmentSourceIndexCounts': equipment_sources.get('counts'),
        'equipmentTtsPhysicalFaceRecords': len(equipment_validation['faceRuleIds']),
        'equipmentOfficialFaceRecords': len(equipment_validation['officialRuleIds']),
        'equipmentClassConflictExclusions': len(equipment_validation['conflicts']),
        'equipmentBacklogSourceFaceTuples': sum(unit_id.startswith('CARD:') for unit_id in equipment_validation['linkedBacklogIds']),
        'actionPhysicalOccurrences': len(action_validation['faces']),
        'actionCharacterDecks': len(action_validation['decks']),
        'actionRootDecks': len(action_validation['roots']),
        'actionSourceFaceAssets': len(action_validation['assets']),
        'actionDirectOccurrences': sum((item.get('sourceSelector') or {}).get('generatedSpriteSheetCell') is False for item in action_validation['faces']),
        'actionGeneratedOccurrences': sum((item.get('sourceSelector') or {}).get('generatedSpriteSheetCell') is True for item in action_validation['faces']),
        'actionSourceSheets': len(action_validation['sheets']),
        'actionSelectorGaps': len(action_validation['gaps']),
        'actionSharedBackOccurrences': 1 if action_validation['back'] else 0,
        'actionSharedBackReferences': action_validation['back'].get('globalReferenceCount'),
        'actionUniqueTitles': len({item.get('printedTitle') for item in action_validation['faces']}),
        'actionPrintedSentences': sum(len(item.get('sentences') or []) for item in action_validation['faces']),
        'actionPhysicalPanels': sum(len(item.get('panels') or []) for item in action_validation['faces']),
        'actionOperativePanels': sum(sum(panel.get('operative') is True for panel in item.get('panels') or []) for item in action_validation['faces']),
        'actionFunctionalIconOccurrences': sum(len(item.get('iconOccurrences') or []) for item in action_validation['faces']),
        'actionMatchedIconOccurrences': sum(sum(icon.get('semanticReferenceId') is not None for icon in item.get('iconOccurrences') or []) for item in action_validation['faces']),
        'actionUnresolvedLocalGlyphOccurrences': sum(sum(icon.get('semanticReferenceId') is None for icon in item.get('iconOccurrences') or []) for item in action_validation['faces']),
        'actionResolvedNotInCombatOccurrences': sum((item.get('notInCombat') or {}).get('status') == 'source-resolved' for item in action_validation['faces']),
        'actionUnresolvedUpperRightOccurrences': sum((item.get('notInCombat') or {}).get('status') == 'literal-unresolved' for item in action_validation['faces']),
        'actionZeroPlayCosts': sum(item.get('playActionCardBasicActionCost') == 0 for item in action_validation['faces']),
        'actionAdditionalCostClauses': sum(len(item.get('printedCostClauses') or []) for item in action_validation['faces']),
        'actionCommandHeadings': sum(sum(panel.get('heading') == 'COMMAND' for panel in item.get('panels') or []) for item in action_validation['faces']),
        'actionReactionHeadings': sum(sum(panel.get('heading') == 'REACTION' for panel in item.get('panels') or []) for item in action_validation['faces']),
        'actionLicensedOccurrences': len(action_validation['licensed']),
        'actionLicensedReactionOccurrences': sum(bool(item.get('reactionDesc')) for item in action_validation['licensed']),
        'actionLicensedCommandOccurrences': sum(item.get('command') is True for item in action_validation['licensed']),
        'actionLicensedNotInCombatOccurrences': sum(item.get('noIntruders') is True for item in action_validation['licensed']),
        'actionOfficialFaceOccurrences': len(action_validation['official'].get('faces') or []),
        'actionOfficialBackOccurrences': len(action_validation['official'].get('backs') or []),
        'actionFaqOccurrences': len(action_validation['faq']),
        'actionExpansionRootsExcluded': len((action_sources.get('excludedContent') or {}).get('expansionCharacterActionRoots') or []),
