...
def build_room_records(repo, record, assertion, timing, participant, condition, decision, operation):
    ...
    add('03',['term.serious-wound-card','term.character-health'],['tax.entity.component.card.serious-wound','tax.state.health'],[
        ...
        operation('S01',1,'change-value','may','P-PLAYER','restore chosen amount up to 2 Character Health',['SA-ROOM-03-E'],conditions=['restore Health branch'],decision_ref='D-ROOM-03-HEALTH',value_change={'amount':'player-chosen-0-to-2','value':'Health damage'}),operation('S02',2,'invoke-process','must','P-RULES','selected Serious Wound through the reusable discard/slide procedure',['SA-ROOM-03-E'],conditions=['discard Wound branch'],decision_ref='D-ROOM-03-WOUND',invoke='SEM-SERIOUS-WOUND-DISCARD-001')])
