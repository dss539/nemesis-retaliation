...
links={
 'RULE:RT-001':['SEM-RT-001'],'RULE:RT-004':['SEM-RT-004'],'RULE:RT-005':['SEM-RT-005'],'RULE:RT-007':['SEM-RT-007'],
 'RULE:ACT-MOVE-001':['SEM-ACT-MOVE-001'],'RULE:ACT-EXPLORE-001':['SEM-ACT-EXPLORE-001'],'RULE:ACT-SEARCH-001':['SEM-ACT-SEARCH-001'],
 'RULE:ACT-CARD-001':['SEM-ACT-SEARCH-001','SEM-ACT-REST-001'],'RULE:INT-001':['SEM-INTRUDER-HELP-QA-R01'],'RULE:INT-008':['SEM-ACT-REST-001','SEM-ENDGAME-001'],'RULE:INT-011':['SEM-ENDGAME-001'],
