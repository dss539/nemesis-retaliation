...
contradictions = {
    ...
    'conflicts': [
        ...
        {'conflictId':'SC-003','title':'Exploration Entrance Noise versus universal Movement Noise','status':'unresolved','questionId':'SEM-Q-002','affectedRuleIds':['SEM-ACT-EXPLORE-001','SEM-ACT-MOVE-001'],'evidenceRefs':['SRC-RULEBOOK'],'difference':'Noise is mandatory after every Movement; Entrance Effect is called additional; the worked example resolves one Entrance Noise and then finishes.','resolution':'No default; explicit alternatives in review-gates.json.'},
