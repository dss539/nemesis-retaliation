...
records.append(record(
    ...
    [operation('S01',1,'select-target','must','rules-system','next non-Passed Player',['SA-RT004-1'],target_ref='T-NEXT-PLAYER'),operation('S02',2,'invoke-process','must','selected Player','Turn',['SA-RT004-1'],repeat={'untilConditionRef':'C-ALL-PASSED'}),operation('S03',3,'invoke-process','must','rules-system','Intruder Phase',['SA-RT004-1'],conditions=['C-ALL-PASSED'])],
...
records.append(record(
    ...
    [operation('S01',1,'invoke-selected-process','must','P-ACTIVE-CHARACTER','selected Action',['SA-RT005-1'],decision_ref='D-ACTION-1'),operation('S02',2,'invoke-selected-process','must','P-ACTIVE-CHARACTER','selected Action',['SA-RT005-1'],decision_ref='D-ACTION-2'),operation('S03',3,'change-value','if-able','P-ACTIVE-CHARACTER','Oxygen',['SA-RT005-1'],conditions=['Character is in a Section with inactive Life Support'],value_change={'amount':-1,'valueTaxonId':'tax.value.resource.oxygen'}),operation('S04',4,'change-value','if-able','P-ACTIVE-CHARACTER','Character Health',['SA-RT005-1'],conditions=['Character is in a Room with Fire'],value_change={'amount':-1,'valueTaxonId':'tax.state.health.point'})],
