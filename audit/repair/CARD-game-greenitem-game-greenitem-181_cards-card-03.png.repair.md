...
> CARD CORPUS RECORD — game/greenitem / game-greenitem-181_cards-card-03.png
> extraction state: verified-canonical; readiness: canonical
> rules text present: True
>
> typeLine: ONE USE ONLY
> body: Only in a [computer] Room without [malfunction].
> Choose any Room in the Facility
> and place a closed Door in
> each adjacent Corridor.
> source: assets/tts-mod/extract/v2-dl/tree/cards/game/greenitem-181_cards/card-03.png
