...
> CARD CORPUS RECORD — game/objectiveMissonDeck / game-objectiveMissonDeck-162_cards-card-13.png
> extraction state: draft-full; readiness: draft-text-complete-symbols-unresolved
> rules text present: True
>
> title: GREENER PASTURES
> body: Character of the Player 2 cannot Survive.
> (If you are the Player 2 you have to fulfill
> the second option from this Objective)
>
> OR
>
> You have to be the only Survivor.
> section: Character of the Player 2 cannot Survive.
> (If you are the Player 2 you have to fulfill
> the second option from this Objective)
> section: You have to be the only Survivor.
> source: assets/tts-mod/extract/v2-dl/tree/cards/game/objectiveMissonDeck-162_cards/card-13.png
