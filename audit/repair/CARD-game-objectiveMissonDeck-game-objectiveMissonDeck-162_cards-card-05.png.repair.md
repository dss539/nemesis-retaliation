...
> CARD CORPUS RECORD — game/objectiveMissonDeck / game-objectiveMissonDeck-162_cards-card-05.png
> extraction state: draft-full; readiness: draft-text-complete
> rules text present: True
>
> title: ULTERIOR MOTIVE
> body: You must choose this Objective.
> Mission Task must not be Fulfilled.
> source: assets/tts-mod/extract/v2-dl/tree/cards/game/objectiveMissonDeck-162_cards/card-05.png
