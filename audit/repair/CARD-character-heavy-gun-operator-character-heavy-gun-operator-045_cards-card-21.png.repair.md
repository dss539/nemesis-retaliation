...
> CARD CORPUS RECORD — character/heavy-gun-operator / character-heavy-gun-operator-045_cards-card-21.png
> extraction state: draft-full; readiness: draft-text-complete
> rules text present: True
>
> title: COMPUTER SKILLS
> body: If you are in [computer] Room,
> use the Room.
>
> OR
>
> Open or Close 1 chosen Door in the Facility.
> source: assets/tts-mod/extract/v2-dl/tree/cards/character/heavy-gun-operator-045_cards/card-21.png
