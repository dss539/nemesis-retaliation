...
> CARD CORPUS RECORD — reference / reference-card-034_cards-card-04.png
> extraction state: complete-non-rules-or-reference; readiness: not-rules-bearing-or-reference
> rules text present: True
>
> title: - HELP CARD -
> typeLine: YOU ARE PLAYER
> 5
> body: PLAYER PHASE
...
>
> END OF ROUND
> source: assets/tts-mod/extract/v2-dl/tree/cards/reference/card-034_cards/card-04.png
