...
> CARD CORPUS RECORD — game/missionTaskDeck / game-missionTaskDeck-160_cards-card-07.png
> extraction state: draft-full; readiness: draft-text-complete-symbols-unresolved
> rules text present: True
>
> title: ESCORT MISSION
> body: The Robot must reach the Reactor.
> source: assets/tts-mod/extract/v2-dl/tree/cards/game/missionTaskDeck-160_cards/card-07.png
